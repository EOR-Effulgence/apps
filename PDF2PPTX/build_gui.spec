...
"""
PyInstaller spec file for PDF2PNG/PDF2PPTX Converter GUI Edition
...
Usage:
    ...
    pyinstaller build_gui.spec --clean --noconfirm

Output:
    dist/PDF2PNG_GUI.exe - Qt6-based Windows executable
"""
